...
public static class BoardVisualizationExtensions
{
    ...
    public static void Visualize(this Board board, string title = "Chess Board Visualization",
    ...
    /// <param name="title">The title of the window.</param>
    /// <param name="waitForClose">Whether to wait for the window to be closed before continuing.</param>
    public static void VisualizeBoard(this Game game, string title = "Chess Board Visualization",
        bool waitForClose = false)
    {
