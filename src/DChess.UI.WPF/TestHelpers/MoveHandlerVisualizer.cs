...
public static class MoveHandlerVisualizer
{
    ...
    /// <param name="title">The title of the visualization window.</param>
    /// <param name="waitForClose">Whether to wait for the window to be closed before continuing.</param>
    public static void VisualizeMove(Game game, Move move, string title = "Move Visualization", bool waitForClose = false)
    {
    ...
    /// <param name="title">The title of the visualization window.</param>
    /// <param name="waitForClose">Whether to wait for the window to be closed before continuing.</param>
    public static void VisualizeBestMove(Game game, Colour colour, int maxDepth = 3, string title = "Best Move Visualization", bool waitForClose = false)
    {
        // Find the best move
    ...
    /// <param name="title">The title of the visualization window.</param>
    /// <param name="waitForClose">Whether to wait for the window to be closed before continuing.</param>
    public static void VisualizeGameStateScore(Game game, Colour colour, string title = "Game State Score Visualization", bool waitForClose = false)
    {
        // Calculate the score
        var score = MoveHandler.GetGameStateScore(game, colour);
