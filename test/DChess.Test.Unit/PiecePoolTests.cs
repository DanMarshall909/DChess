...
public class PiecePoolTests
{
    ...
    [Fact(DisplayName = "A pieceProperties can be retrieved from the pool")]
    public void a_piece_can_be_retrieved_from_the_pool()
    {
        // Arrange
        var board = new Board(_invalidMoveHandler);
        var chessPiece = new PieceProperties(PieceType.Pawn, White);
        ...
        piece.Should().Be(secondPieceWithSameDefinition, "the pieceProperties should be the same instance");
